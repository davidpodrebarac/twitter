...
ROOT_DIR = environ.Path(__file__) - 3  # (twitter/config/settings/base.py - 3 = twitter/)
...
ADMINS = [
    ("""David Podrebarac""", 'podrebarac.david@mail.com'),
]
...
JWT_AUTH = {
    ...
    'JWT_RESPONSE_PAYLOAD_HANDLER': 'twitter.users.serializers.jwt_response_payload_handler',
}
